...
TEST_F(WalletLegacyApi, sendBulkOfMessages) {
  ...
  std::string verse1 = "Daring DNC of mystery, \n"
    "Champion of right, \n"
  ...
  std::string chorus = "(3-2-1) Darkwing DNC (When there's trouble you call DW) \n"
    "Darkwing DNC (Let's get dangerous) \n"
    "Darkwing DNC (Darkwing, Darkwing Duck!) \n";
  ...
  std::string verse3 = "'Cause here comes (Darkwing DNC) \n"
    "Look out! (When there's trouble you call DW) \n"
    "Darkwing DNC (Let's get dangerous) \n"
    "Darkwing DNC (Better watch out, you bad boys) \n"
    "Darkwing DNC!\n";
